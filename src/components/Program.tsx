  ...
  const schedule = [
    {
      ...
      sessions: [
        ...
        { time: "16:00–16:45", title: "Human in the Loop: Responsible Use of Generative AI Tools in Software Engineering Practice", speaker: "Pr. Bruce Maxim", type: "Remote" },
                    ...
                    <CardContent className="p-4 md:p-6">
                      <div className="flex flex-col md:flex-row gap-4">
                        ...
                        <div className="md:w-32 flex-shrink-0 space-y-2">
                          ...
                          {isLive && (
                            <Badge className="bg-red-500 hover:bg-red-600 text-white text-xs animate-pulse block w-fit">
                              LIVE NOW
                            </Badge>
                          )}
                          {countdown && (
